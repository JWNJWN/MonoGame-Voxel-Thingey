...
namespace Voxel.Engine.GeometricPrimitives
{
    ...
    public class SpherePrimitive : GeometricPrimitive
    {
        ...
        /// </summary>
        public SpherePrimitive(GraphicsDevice graphicsDevice, Color color)
            : this(graphicsDevice, 1, 16, color)
        {
        }
                               ...
                               float diameter, int tessellation, Color color)
        {
            ...
            AddVertex(Vector3.Down * radius, Vector3.Down, Color.WhiteSmoke);
            ...
            AddVertex(Vector3.Up * radius, Vector3.Up, color);
