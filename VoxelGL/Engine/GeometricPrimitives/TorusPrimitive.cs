...
namespace Voxel.Engine.GeometricPrimitives
{
    ...
    public class TorusPrimitive : GeometricPrimitive
    {
        ...
        /// </summary>
        public TorusPrimitive(GraphicsDevice graphicsDevice, Color color)
            : this(graphicsDevice, 1, 0.333f, 32, color)
        {
        }
        ...
        public TorusPrimitive(GraphicsDevice graphicsDevice,
                              float diameter, float thickness, int tessellation, Color color)
        {
            if (tessellation < 3)
